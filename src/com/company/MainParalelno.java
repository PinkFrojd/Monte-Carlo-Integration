...
public class MainParalelno {

    public static Slika slika = null;
    public static int ponavljanje = 40000;
    public static volatile double odnos = 0.0;
    public static double unutarnji1 = 0.0;
    public static double unutarnji2 = 0.0;

    public static void main(String[] args) throws InterruptedException {

        String imeSlike = "Krug.png";
        slika = new Slika(imeSlike);

        System.out.println("Poziv Monte Carlo Simulacije nad " + imeSlike);
        PlatnoZaCrtanjeParalelno pl = new PlatnoZaCrtanjeParalelno(slika.pravaSlika.getWidth(),
        ...
        System.out.println("Vrijeme izvodjenja paralelno: " + ((t2-t1)/1000000000.0) + " s");
